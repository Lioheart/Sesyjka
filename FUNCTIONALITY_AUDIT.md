...
| Obszar źródłowy | Stan portu GTK4 0.9.10 |
|---|---|
...
Wersja 0.9.10 nie manipuluje prywatnymi widgetami wierszy Gtk.ColumnView. Port zachowuje podstawowy przepływ pracy programu źródłowego: katalog kolekcji RPG, sesje, gracze, wydawcy, statystyki, filtry, transfer i bezpieczeństwo czterech baz. Wersja 0.9.10 obejmuje kolekcję planszówek i karcianek jako niezależne rozszerzenie w piątym pliku. Nie zmienia schematów czterech baz projektu źródłowego. Sesyjka Cloud dodaje wyłącznie osobną bazę `sync.db` z metadanymi synchronizacji i konfliktami.


## Zasoby cyfrowe 0.9.10
