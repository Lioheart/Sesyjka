...
Wersja 0.9.1 dodaje opcjonalną warstwę Sesyjka Cloud opartą na Supabase Auth i Data REST API. Stan synchronizacji jest odseparowany w `sync.db`, a schematy baz projektu źródłowego nie są przez tę funkcję zmieniane.
